...
function App() {
    ...
    return (_jsx(ThemeProvider, { children: _jsxs(Router, { children: [_jsx(PageMeta, {}), _jsx(RouteMemory, { user: Boolean(user) }), _jsx(CookieBanner, {}), loading ? _jsx(Routes, { children: _jsx(Route, { path: "*", element: _jsx(AuthLoadingScreen, {}) }) }) : (_jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Landing, {}) }), _jsx(Route, { path: "/about", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/privacy", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/terms", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/thank-you", element: _jsx(ThankYouPage, {}) }), !user ? (_jsxs(_Fragment, { children: [_jsx(Route, { path: "/auth", element: _jsx(AuthPage, {}) }), _jsx(Route, { path: "*", element: verificationEmail ? _jsx(Navigate, { to: "/auth?verify=1", replace: true }) : _jsx(NotFoundPage, {}) })] })) : (_jsx(Route, { path: "/*", element: _jsx(AuthedRoutes, {}) }))] }))] }) }));
}
export default App;
