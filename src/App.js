...
function AuthedRoutes() {
    return (_jsx(AppLayout, { children: _jsx(ConsentGate, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/auth", element: _jsx(AuthPage, {}) }), _jsx(Route, { path: "/dashboard", element: _jsx(DashboardPage, {}) }), _jsx(Route, { path: "/tasks", element: _jsx(TasksPage, {}) }), _jsx(Route, { path: "/task-tracking", element: _jsx(TaskTrackingPage, {}) }), _jsx(Route, { path: "/tasks/:taskCode", element: _jsx(TaskRunnerPage, {}) }), _jsx(Route, { path: "/verify", element: _jsx(VerifyPage, {}) }), _jsx(Route, { path: "/deposit", element: _jsx(DepositPage, {}) }), _jsx(Route, { path: "/financials", element: _jsx(FinancialsPage, {}) }), _jsx(Route, { path: "/admin/payments", element: _jsx(AdminPaymentsPage, {}) }), _jsx(Route, { path: "/profile", element: _jsx(ProfileCompletionPage, {}) }), _jsx(Route, { path: "/notifications", element: _jsx(NotificationsPage, {}) }), _jsx(Route, { path: "/settings", element: _jsx(SettingsPage, {}) }), _jsx(Route, { path: "/about", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/privacy", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/terms", element: _jsx(TermsOfUsePage, {}) }), _jsx(Route, { path: "/terms-of-use", element: _jsx(TermsOfUsePage, {}) }), _jsx(Route, { path: "/contact", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/data-policy", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/requester/apply", element: _jsx(RequesterKycPage, {}) }), _jsx(Route, { path: "/requester/tasks", element: _jsx(RequesterTasksPage, {}) }), _jsx(Route, { path: "/thank-you", element: _jsx(ThankYouPage, {}) }), _jsx(Route, { path: "*", element: _jsx(NotFoundPage, {}) })] }) }) }));
}
function App() {
    ...
    return (_jsx(ThemeProvider, { children: _jsxs(Router, { children: [_jsx(AuthCallbackRedirect, {}), _jsx(PageMeta, {}), _jsx(RouteMemory, { user: Boolean(user) }), _jsx(CookieBanner, {}), loading ? (_jsx(Routes, { children: _jsx(Route, { path: "*", element: _jsx(AuthLoadingScreen, {}) }) })) : (_jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Landing, {}) }), _jsx(Route, { path: "/about", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/privacy", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/terms", element: _jsx(TermsOfUsePage, {}) }), _jsx(Route, { path: "/terms-of-use", element: _jsx(TermsOfUsePage, {}) }), _jsx(Route, { path: "/contact", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/data-policy", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/requester/apply", element: _jsx(RequesterKycPage, {}) }), _jsx(Route, { path: "/requester/tasks", element: _jsx(RequesterTasksPage, {}) }), _jsx(Route, { path: "/thank-you", element: _jsx(ThankYouPage, {}) }), _jsx(Route, { path: "/auth", element: _jsx(AuthPage, {}) }), user ? (_jsx(Route, { path: "/*", element: _jsx(AuthedRoutes, {}) })) : (_jsx(Route, { path: "*", element: verificationEmail ? _jsx(Navigate, { to: "/auth?verify=1", replace: true }) : _jsx(NotFoundPage, {}) }))] }))] }) }));
}
export default App;
