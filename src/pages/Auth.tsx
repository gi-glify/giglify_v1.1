...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 transition-colors" style={{ background: 'var(--bg)', color: 'var(--text)' }}>
      <button
        onClick={toggleTheme}
      ...
      <div className="w-full max-w-md animate-in" data-aos="zoom-in">
        ...
        <div className="text-center mb-8 flex flex-col items-center gap-3">
          <img src="/giglify.svg" alt="Giglify" className="h-16 w-16 rounded-xl" />
          <p className="text-sm font-body" style={{ color: 'var(--text-muted)' }}>Microtasking, Done Right.</p>
        </div>
