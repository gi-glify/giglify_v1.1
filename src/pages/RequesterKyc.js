...
export default function RequesterKycPage() {
    ...
    return _jsxs("main", { className: "container max-w-3xl py-8", style: { color: "var(--text)" }, children: [_jsx("section", { className: "card mb-6", "data-aos": "fade-down", children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx(ShieldCheck, { className: "text-brand-600 dark:text-brand-300 shrink-0" }), _jsxs("div", { children: [_jsx("h1", { className: "font-display text-2xl", children: "Bring your work to life with Giglify" }), _jsx("p", { className: "text-sm mt-2", style: { color: "var(--text-muted)" }, children: "Turn ideas, research, and real business needs into high-quality tasks. Get them in front of a vetted worker community that is ready to deliver useful results." })] })] }) }), application ? _jsxs("section", { className: "card", "data-aos": "fade-up", children: [_jsxs("p", { className: "text-sm font-semibold", children: ["Application status: ", _jsx("span", { className: "capitalize", children: application.status.replace("-", " ") })] }), _jsxs("p", { className: "text-sm mt-2", style: { color: "var(--text-muted)" }, children: ["Review notification available from ", new Date(application.review_available_at).toLocaleString(), "."] }), application.admin_note && _jsx("p", { className: "alert alert-info mt-4 text-sm", children: application.admin_note }), ["review-ready", "approved"].includes(application.status) && _jsx(Link, { to: "/requester/tasks", className: "btn-primary inline-flex mt-5", children: "Create your first task" })] }) : _jsxs("form", { className: "card space-y-4", "data-aos": "fade-up", onSubmit: submit, children: [_jsx("h2", { className: "font-display text-xl", children: "Set up your requester profile" }), _jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [_jsxs("label", { className: "text-sm font-semibold", children: ["Legal name", _jsx("input", { className: "input-field w-full mt-2", required: true, value: form.legalName, onChange: (e) => setForm({ ...form, legalName: e.target.value }) })] }), _jsxs("label", { className: "text-sm font-semibold", children: ["Organization (optional)", _jsx("input", { className: "input-field w-full mt-2", value: form.organization, onChange: (e) => setForm({ ...form, organization: e.target.value }) })] }), _jsxs("label", { className: "text-sm font-semibold", children: ["Phone", _jsx("input", { className: "input-field w-full mt-2", required: true, inputMode: "tel", value: form.phone, onChange: (e) => setForm({ ...form, phone: e.target.value }) })] }), _jsxs("label", { className: "text-sm font-semibold", children: ["Country", _jsx("input", { className: "input-field w-full mt-2", required: true, value: form.country, onChange: (e) => setForm({ ...form, country: e.target.value }) })] }), _jsxs("label", { className: "text-sm font-semibold", children: ["ID type", _jsxs("select", { className: "input-field w-full mt-2", value: form.idType, onChange: (e) => setForm({ ...form, idType: e.target.value }), children: [_jsx("option", { value: "national_id", children: "National ID" }), _jsx("option", { value: "passport", children: "Passport" }), _jsx("option", { value: "business_registration", children: "Business registration" })] })] }), _jsxs("label", { className: "text-sm font-semibold", children: ["ID number", _jsx("input", { className: "input-field w-full mt-2", required: true, inputMode: "numeric", value: form.idNumber, onChange: (e) => setForm({ ...form, idNumber: e.target.value }) })] })] }), _jsxs("label", { className: "text-sm font-semibold block", children: ["Identity document", _jsx("input", { className: "input-field w-full mt-2", type: "file", accept: "image/*,.pdf", required: true, onChange: (e) => setDocument(e.target.files?.[0] || null) })] }), _jsxs("label", { className: "text-sm font-semibold block", children: ["What would you like to get done?", _jsx("textarea", { className: "input-field w-full mt-2 min-h-32", required: true, minLength: 20, value: form.taskBrief, onChange: (e) => setForm({ ...form, taskBrief: e.target.value }), placeholder: "Describe the work, audience, expected result, and quality standard." })] }), error && _jsx("p", { className: "alert alert-error text-sm", children: error }), state === "sent" && _jsx("p", { className: "alert alert-success text-sm", children: "Your requester profile was submitted. We will notify you when you can publish your first task." }), _jsx("button", { className: "btn-primary", disabled: state === "loading", children: state === "loading" ? "Setting up securely..." : "Continue to task publishing" }), _jsx("p", { className: "text-xs", style: { color: "var(--text-muted)" }, children: "Documents are stored privately for review and are not visible to workers." })] })] });
}
