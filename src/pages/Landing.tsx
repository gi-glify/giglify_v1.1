...
export default function Landing() {
  ...
  const steps = [
    {
      number: '01',
      title: 'Post a Task',
      description: 'Break down your project into small, manageable microtasks with clear instructions and fair compensation.',
    },
    {
      number: '02',
      title: 'Expert Completion',
      description: 'Our vetted community of workers completes your tasks quickly with high-quality results.',
    },
    {
      number: '03',
      title: 'Scale Instantly',
      description: 'Grow your project from concept to thousands of validated data points in days, not months.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#how-it-works" className="text-sm font-medium text-slate-text hover:text-navy-900 transition">
              How it Works
            </a>
            <a href="#stats" className="text-sm font-medium text-slate-text hover:text-navy-900 transition">
              Stats
            </a>
            <a href="#" className="text-sm font-medium text-slate-text hover:text-navy-900 transition">
              Pricing
            </a>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white border-b border-slate-200 shadow-lg animate-in">
            <div className="flex flex-col p-6 gap-4">
              <a href="#how-it-works" onClick={() => setIsMenuOpen(false)} className="text-base font-medium text-slate-text hover:text-navy-900 transition">
                How it Works
              </a>
              <a href="#stats" onClick={() => setIsMenuOpen(false)} className="text-base font-medium text-slate-text hover:text-navy-900 transition">
                Stats
              </a>
              <a href="#" onClick={() => setIsMenuOpen(false)} className="text-base font-medium text-slate-text hover:text-navy-900 transition">
                Pricing
              </a>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 md:py-32 grid md:grid-cols-2 gap-12 items-center">
        <div data-aos="fade-right">
          ...
          <p className="text-xl text-slate-text mb-8 leading-relaxed">
            Post tasks, get results. Giglify connects your project with thousands of vetted workers ready to help you scale faster.
          </p>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="max-w-6xl mx-auto px-6 py-20 md:py-32">
        <div className="text-center mb-16" data-aos="fade-up">
          <h2 className="text-4xl md:text-5xl font-bold text-navy-900 mb-4">
            Simple, Three-Step Process
          </h2>
          <p className="text-xl text-slate-text max-w-2xl mx-auto">
            From concept to completion, our streamlined workflow makes scaling effortless.
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          {steps.map((step, i) => (
            <div key={i} className="flex flex-col" data-aos="fade-up" data-aos-delay={i * 100}>
              <div className="mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg" data-aos="fade-left">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-navy-900 mb-1">Fast Results</h4>
                    <p className="text-slate-text">Average task completion in 24 hours</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-primary-amber rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h4 className="font-semibold text-navy-900 mb-1">Quality Assured</h4>
                    <p className="text-slate-text">Automated validation ensures accuracy</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-primary-amber rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h4 className="font-semibold text-navy-900 mb-1">Expert Network</h4>
                    <p className="text-slate-text">Vetted professionals ready to work</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* CTA Section */}
      <section className="max-w-6xl mx-auto px-6 py-20 md:py-32 text-center" data-aos="zoom-in">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <img src="/giglify.svg" alt="Giglify" className="h-8 w-8 rounded" />
                <span className="font-bold">Giglify</span>
              </div>
              <p className="text-sm text-slate-400">Microtasking, done right.</p>
            </div>
            <div>
