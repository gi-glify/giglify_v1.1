...
function ProfileReadOnlyView({ form, locked, appealStatus, appealReason, onEdit, onSubmitAppeal, onReasonChange, submitting }) {
    const rows = [
        ["Email", form.email],
