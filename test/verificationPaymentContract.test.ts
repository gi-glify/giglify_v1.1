...
test("accepts PayPal approval and PalPluss STK verification input", () => {
...
test("rejects unsupported providers and provider-specific invalid fields", () => {
  ...
  assert.equal(parseVerificationPaymentRequest({ method: "palpluss", accountLabel: "x", accountValue: "123", phone: "123" }), null);
});
